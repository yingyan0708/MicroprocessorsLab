...
setup:	bcf	CFGS	; point to Flash program memory  
	...
	call	ADC_Setup
	;clrf	TRISF, A	; set portD as digital output for seconds display
	;clrf	TRISE, A
	;initialise GLCD
...
loop_page:
	movf	page_counter, W
	addlw	0xB8 ; add counter value to get page value
	call	send_command
	movlw	0x40
	call	send_command
	movf	page_counter, W
...
page_setup_CS2:
	movlw	0x00
	movwf	page_counter_CS2, A
loop_page_CS2:
	movf	page_counter_CS2, W
	addlw	0xB8 ; add counter value to get page value
	call	send_command
	movlw	0x40
	call	send_command
	movf	page_counter_CS2, W
	sublw	0x08
	movwf	subtract_CS2, A
	movlw	0x00
	cpfseq	subtract_CS2
	goto	not_last_page_CS2
	clrf	page_counter_CS2, A
	return
not_last_page_CS2:
	incf	page_counter_CS2
	return
	
GLCD_print:
	movf	high_nibble_ASCII, W
	call	compare_number
	movf	low_nibble_ASCII, W
	call	compare_number
	return
